...
variable "dns_zone" {
  type        = "string"
  description = "Cloudflare domain (i.e. DNS zone) (e.g. hcloud.example.com)"
}
...
variable "channel" {
  type        = "string"
  default     = "stable"
  description = "Container Linux for instances (e.g. stable, beta, alpha)"
}
...
variable "ssh_ids" {
  type        = "list"
  description = "SSH public key IDs."
}
